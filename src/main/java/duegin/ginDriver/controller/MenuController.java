...
public class MenuController {
    ...
    public Result<Menu> getInfo(@PathVariable Serializable id) {
     ...
     */
    @GetMapping("/page")
    public Result<Page<Menu>> page(Page<Menu> page) {
        return Result.ok(menuService.page(page));
    }

    @GetMapping("/list/{type}")
    public Result<List<MenuVO>> getListByType(@PathVariable Integer type){
        return Result.ok(menuService.getMenuByType(type));
    }
}