package duegin.ginDriver.groupAuth.aspectj;

import duegin.ginDriver.domain.po.Group;
import duegin.ginDriver.domain.vo.GroupVO;
import duegin.ginDriver.groupAuth.HasGroupRole;
...
//    private static final String DISABLED = "ROLE_GROUP_DISABLED";
    ...
    public void before(JoinPoint joinPoint, HasGroupRole hasGroupRole) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        for (Object arg : args) {
            ...
            if(name.equals("group") && (arg instanceof Group || arg instanceof GroupVO)){
