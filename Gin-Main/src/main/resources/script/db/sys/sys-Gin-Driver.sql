...
CREATE TABLE `menu` (
                        ...
                        PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜单权限表';
...
INSERT INTO `menu` VALUES (9,'首页',0,'/media/home','/media/index','MediaHome',3,'tdesign:home',2,0,1,3,0,NULL,'2023-12-24 12:38:53','2024-02-07 14:01:14');
...
INSERT INTO `menu` VALUES (13,'媒体',0,'/media/home',NULL,'MediaHome',NULL,'tabler:photo',2,0,1,5,0,NULL,'2024-01-29 14:13:45','2024-02-07 14:02:55');
...
INSERT INTO `menu` VALUES (32,'压缩文件测试',0,'/test/jsZip','/test/jsZipTest','JsZipTest',2,NULL,1,0,1,11,0,NULL,'2024-02-16 16:19:27','2024-02-16 16:26:46');
INSERT INTO `menu` VALUES (33,'测试exif',0,'/test/exifr','/test/exifrTest','ExifrTest',2,NULL,1,0,1,11,0,NULL,'2024-02-16 16:21:24','2024-02-16 16:28:39');
INSERT INTO `menu` VALUES (34,'测试文件压缩',0,'/test/jsZip',NULL,'JsZipTest',NULL,'bi:file-zip',1,0,1,5,0,NULL,'2024-02-16 16:22:39','2024-02-16 16:24:27');
INSERT INTO `menu` VALUES (35,'测试exif',0,'/test/exifr',NULL,'ExifrTest',NULL,'arcticons:exifthumbnailadder',1,0,1,5,0,NULL,'2024-02-16 16:25:13','2024-02-16 16:25:13');
...
-- Dump completed on 2024-02-17  0:30:45
